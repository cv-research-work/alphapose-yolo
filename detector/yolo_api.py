...
class YOLODetector(BaseDetector):
    def __init__(self, cfg, opt=None):
        ...
        self.model_cfg = cfg.get('CONFIG', 'detector/yolo-new/config/yolov3.cfg')
        self.model_weights = cfg.get('WEIGHTS', 'detector/yolo-new/weights/yolov3.weights')
        self.inp_dim = cfg.get('INP_DIM', 416)
